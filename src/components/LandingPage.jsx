      ...
      <header className="bg-white py-6">
        <div className="container mx-auto px-6 flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 w-full">
            ...
            <p className="mt-8 ml-20 text-sm lg:text-xl text-justify  text-gray-600">
            ...
            <button className="mt-10 bg-orange-500 text-white py-3 px-6  rounded-lg transition-transform 
            flex mx-auto
            transform hover:scale-105 hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-opacity-50
            ">
  Start Your Journey
</button>
          </div>
