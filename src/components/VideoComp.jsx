...
const FeaturesComponent = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center font-inter p-2 lg:mx-32">
      {/* Video Card */}
      ...
      <div className="relative flex flex-col items-center h-full w-full md:w-1/2 p-2 md:p-4 mx-auto">
        <div className="p-4 md:p-6 rounded-lg text-gray-800 fade-in-right">
          ...
          <a
            href="#courses"
            className="relative ml-[23rem] justify-center w-36 flex items-center align-center mt-7 p-4 px-4 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out rounded-xl shadow-xl group hover:ring-1 hover:ring-purple-500"
          >
            <span className="absolute inset-0 w-full h-full bg-gradient-to-br from-orange-600 via-orange-600 to-orange-700"></span>
